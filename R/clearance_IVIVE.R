...
clearance_IVIVE <- function(typeValue, units, expData, typeSystem, partitionQSPR, logLipo,
  ...
  rlang::arg_match(typeSystem, c(
    "hepatocytes",
    "microsomes"
  ))

  rlang::arg_match(typeValue, c(
    "decay experimentalcurve",
    "halfLife",
  ...
  if (typeValue == "decay experimentalcurve") {
    ...
    matrixCalClear <- cbind(
      ...
      c(
        1 / cInvitro, 1 / cInvitro * 60, 1 / cInvitro / 60,
        1, 1 / 1000, 1000,
