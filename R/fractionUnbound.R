...
#' @examples
#'
calcFractionUnbound<-function(kLip,kPro,kPla,kAir,cCells,cSerum,microplateType,volMedium_mL){
  ...
  fuInvitro=1/(1+kLip*cLip+kPro*cPro+kPla*(surfAreaP_m2/volMedium_L))
